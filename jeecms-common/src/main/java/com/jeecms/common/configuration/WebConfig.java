...
//						SysConstants.DEFAULT_ALLOW_HEADERS + tokenHeader + "," + redirectHeader + "," + siteIdHeader)
	...
	public ServletRegistrationBean<DispatcherServlet> commonDispatcherServletRegistration(
			ObjectProvider<MultipartConfigElement> multipartConfigProvider, DispatcherServlet commonDispatcherServlet) {
		ServletRegistrationBean<DispatcherServlet> registration;
		registration = new ServletRegistrationBean<>(commonDispatcherServlet,
