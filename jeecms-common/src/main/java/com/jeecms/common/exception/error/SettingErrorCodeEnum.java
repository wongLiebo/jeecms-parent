...
public enum SettingErrorCodeEnum implements ExceptionInfo {
    ...
    /** 安全管理员或审计管理员传入错误*/
    SAFE_OR_AUDIT_USER_AFFERENT_ERROR("13171","Safe or audit user afferent error!"),


    /** 操作传入错误*/
    OPERATING_AFFERENT_ERROR("13172","Operating afferent error!"),
    /** 传入的操作与关联操作冲突*/
    AFFERENT_OPERATING_RELATED_OPERATING_CONFLICT("13173","Afferent operating related operating conflict!"),
    /** 传入的操作不是未审核的操作*/
    AFFERENT_OPERATING_NOT_WAIT_REVIEW("13174","Afferent operating not wait review!"),
    /** 三元管理未开启，无法进行修改*/
    TERNARY_MANAGEMENT_IS_NOT_ENABLE("13175","Ternary management is not enabled!"),
    /** 操作不允许为空*/
    OPERATING_NOT_NULL("13176","Operating not null!"),
    /** 安全管理员或审计管理员不允许为空*/
    SAFE_OR_AUDIT_USER_NOT_NULL("13177","Safe or audit user not null!"),
    /** 操作存在待审核的数据*/
    OPERATING_HAS_DATA_PENDING_REVIEW("13178","Operating has data pending review!"),
    /** 三元管理传入id错误*/
    AFFERENT_SAFE_MANAGE_OPERATING_ID_ERROR("13179","Afferent safe manage id error!"),
    /** 不是安全管理员，无法进行操作*/
    NOT_SAFE_ADMIN_NOT_OPERATING("13180","Not safe admin not operating!"),
    /** 请求操作错误*/
    REQUEST_OPERATING_ERROR("13181","Operating error!"),
    /** 模块下存在待审核事项，无法取消三员审核业务，请处理后再操作！*/
    MODULE_HAVE_OPERATING_LOG("13182","Module have operating log！"),
    /** 请保证所选用户中至少有一个用户配置了三员审核菜单权限！*/
    ONE_USER_HAVE_SAFE_MANAGE_MENU_AUTHORITY("13183","One user have safe manage menu authority!"),
    /** 登录用户无法自删*/
    LOGIN_USER_CANNOT_DELETE_THEMSELVES("13184","Login user cannot delete themselves!"),
    /** 消息模板id传入错误*/
    MESSAGE_TPL_ID_INCOMING_ERROR("13185","Message tpl id incoming error!"),


    /** 分保的安全员或审计员传入失败*/
    REINSURANCE_SAFE_OR_AUDIT_USER_AFFERENT_ERROR("13186","Reinsurance safe or audit user afferent error!"),
    /** 用户缺少菜单权限*/
    USER_LACKS_MENU_PERMISSIONS("13187","User lacks menu permissions!"),
    /** 请保证所选用户中至少有一个用户配置了菜单权限！*/
    ONE_USER_HAVE_REINSURANCE_MENU_AUTHORITY("13188","One user have reinsurance menu authority!");
    ;
