...
import com.jeecms.common.wechat.bean.request.mp.message.*;
import com.jeecms.common.wechat.bean.request.mp.user.*;
import com.jeecms.common.wechat.bean.response.mp.BaseResponse;
import com.jeecms.common.wechat.bean.response.mp.user.*;
...
public class UserManageServiceImpl implements UserManageService {
	...
	List<UserListResponse> getOpenid(UserListRequest userListRequest, ValidateToken validToken) throws GlobalException {
		...
		Integer count = userListResponse.getCount();
