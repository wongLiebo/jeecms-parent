...
public class WeiboInfoController extends BaseController<WeiboInfo, Integer> {
	...
	* @throws GlobalException 异常
	...
	@MoreSerializeField({
			@SerializeField(clazz = WeiboInfo.class, includes = { "id", "screenName", "uid"}),
	})
	public ResponseInfo list(Integer siteId) {
		return new ResponseInfo(weiboInfoService.getList(siteId, null));
	}
}
