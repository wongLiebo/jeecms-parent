...
public class ContentSearchController extends BaseController<Content, Integer> {
     ...
     * @param orderBy             排序 28 发布时间升序 27 发布时间降序 没有值则相关度排序
     * @param pageable           分页
    ...
    public Page<Content> searchPage(String keyword, SearchPosition searchPos, SearchKeyCondition keyCondition,
                                    ...
                                    Boolean isTop, Boolean releaseApp, Boolean releaseMiniprogram, Integer orderBy, Pageable pageable,
                                    HttpServletRequest request) throws GlobalException {

        if (orderBy == null) {
            orderBy = ContentConstant.ORDER_TYPE_RELATE;
        }
        if (searchPos == null) {
        ...
        Page<Content> page = luceneService.searchPage(keyword, searchPos, keyCondition, siteId,
                ...
                issueNum, isTop, releasePc, releaseWap, releaseApp, releaseMiniprogram, orderBy, pageable);
