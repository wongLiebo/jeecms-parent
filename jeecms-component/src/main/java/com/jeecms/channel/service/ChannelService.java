...
public interface ChannelService extends IBaseService<Channel, Integer> {
     ...
     * @param user     用户对象
     * @param siteId   站点id
     * @param channels 栏目对象集合
     * @return JSONArray
     */
    JSONArray getChannelsByUserChannelPerm(CoreUser user, Integer siteId, List<Channel> channels);
     ...
     * @return List 栏目集合
     */
    List<Channel> getListForDelete(Integer siteId);
     ...
     * @return Channel
     */
    Channel findByIdAndRecycleAndHasDeleted(Integer id);
     ...
     * @return List<Channel>
     */
    List<Channel> getList(Integer siteId, Boolean recycle);
}
