...
public interface CmsDataPermService extends IBaseService<CmsDataPerm, Integer> {
         ...
         * @param users
         */
        void delete(List<CmsOrg> orgs, List<CoreRole> roles, List<CoreUser> users) throws GlobalException;
         ...
         */
        void updateUserSite(CoreUser user, CmsSite site) throws GlobalException;
