...
public class SysJobConstants {
	 ...
	 * 分组名-定时发布表单
	 */
	public static final String GROUP_NAME_FORM_PUBLISH_FORM = "CmsFormPublishJobGroup";
	/**
	 * 定时任务名字前缀-定时发布表单
	 */
	public static final String NAME_PREFIX_PUBLISH_FORM = "CmsFormPublishJob_";

	/**
	 * 类路径-定时发布表单
	 */
	public static final String CLASS_PATH_PUBLISH_FORM = "com.jeecms.system.job.CmsFormPublishJob";
	 ...
	 * 内容限时置顶
	 */
	public static final String CONTENT_TOP = "com.jeecms.system.job.ContentTopJob";

	/**
	 * 内容限时置顶
	 */
	public static final String GROUP_NAME_CONTENT_TOP = "CmsContentTopJobGroup";

	/**
	 * 内容发布统计相关
	 */
	public static final String CONTENT_PUBLISH = "com.jeecms.system.job.ContentPublishJob";

	/**
	 * 内容发布统计相关
	 */
	public static final String GROUP_NAME_CONTENT_PUBLISH = "CmsContentPublishJobGroup";

	/**
	 * 定时任务名字前缀-内容限时置顶
	 */
	public static final String NAME_PREFIX_CONTENT_TOP = "CmsContentTopJob_";
