...
public class ContentConstant {
	...
	/**查询子栏目*/
	public static final Integer  CHANNEL_OPTION_CHILD = 1;
	/**只有自身栏目内容*/
	public static final Integer  CHANNEL_OPTION_SELF = 0;
	/**包含引用内容*/
	public static final Integer  CHANNEL_OPTION_CHANNELS = 2;
	...
	/**
	 * 内容状态(1:草稿; 2-初稿 3:流转中; 4:已审核; 5:已发布; 6:驳回; 7:下线  9:暂存; 10:智能审核中; 11:审核成功; 12:审核失败 99-归档;)
	 **/
	...
	public static final int STATUS_PIGEONHOLE = 99;


	/**内容列表位置(1 内容列表 2智能审核 3回收站 4已归档 5用户暂存) 为了解决范围查询慢新增字段*/
	public static final Short POS_CONTENT_LIST= 1;
	public static final Short POS_AUDIT= 2;
	public static final Short POS_RECYCLE = 3;
	public static final Short POS_PIGEONHOLE = 4;
	public static final Short POS_MEMBER_SAVE = 5;
	/**内容列表查询状态*/
	public static List<Integer> DEF_QUERY_STATUS = Arrays.asList(ContentConstant.STATUS_DRAFT,ContentConstant.STATUS_FIRST_DRAFT,
	...
	/**智能审核列表查询状态*/
    public static List<Integer> AUDIT_QUERY_STATUS = Arrays.asList(ContentConstant.STATUS_SMART_AUDIT,ContentConstant.STATUS_SMART_AUDIT_SUCCESS,
            ContentConstant.STATUS_SMART_AUDIT_FAILURE);
	...
	public static final int GET_COMMENT_CONTROL = 2;
