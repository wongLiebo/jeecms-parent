...
public interface ContentLuceneService {
     ...
     * @return: boolean
     */
    boolean createIndex(Integer id) throws GlobalException;
     ...
     * @return: boolean
     */
    boolean createIndexBatch(Iterable<Content> contents) throws GlobalException;
     ...
     * @return: boolean
     */
    boolean updateIndexById(Integer id) throws GlobalException;
     ...
     */
    boolean updateIndexByContent(Content content) throws GlobalException;
     ...
     * @return: boolean
     */
    boolean resetIndex(Integer channelId, Integer siteId, Date releaseTimeStart, Date releaseTimeEnd)
     ...
     */
    boolean delete(Iterable<Integer> ids) throws GlobalException;
     ...
     * @return: boolean 成功返回true
     */
    boolean deleteIndexBatch(List<Integer> channelIds, Integer siteId) throws GlobalException;
     ...
     * @return: Page
     */
    Page<Content> searchPage(String keyword, SearchPosition searchPos, SearchKeyCondition keyCondition,
     ...
     * @return: Page
     */
    List<ContentChannelCountVo> searchSummary(String keyword, SearchPosition searchPos,
     ...
     * @return: Page
     */
    Long searchCount(String keyword, SearchPosition searchPosition,
