...
public class QContent extends EntityPathBase<Content> {
    ...
    public final NumberPath<Integer> peopleViews = createNumber("peopleViews", Integer.class);
    ...
    public final StringPath modelFieldSet = createString("modelFieldSet");
    ...
    public final QContent oriContent;

    public final NumberPath<Integer> oriContentId = createNumber("oriContentId", Integer.class);

    public final NumberPath<Short> pos = createNumber("pos", Short.class);
    ...
    public final ListPath<Content, QContent> quoteContents = this.<Content, QContent>createList("quoteContents", Content.class, QContent.class, PathInits.DIRECT2);
    ...
    public QContent(Class<? extends Content> type, PathMetadata metadata, PathInits inits) {
        ...
        this.oriContent = inits.isInitialized("oriContent") ? new QContent(forProperty("oriContent"), inits.get("oriContent")) : null;
