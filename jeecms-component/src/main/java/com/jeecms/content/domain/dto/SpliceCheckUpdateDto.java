...
public class SpliceCheckUpdateDto extends Content{
	...
	public SpliceCheckUpdateDto initSpliceCheckUpdateDto(Content content, SpliceCheckUpdateDto dto,Map<String,String> txtMap) {
		...
		HibernateProxyUtil.loadHibernateProxy(content);
		if(content.getContentAttrs()!=null){
			HibernateProxyUtil.loadHibernateProxy(content.getContentAttrs());
		}
		if(content.getContentTags()!=null){
			HibernateProxyUtil.loadHibernateProxy(content.getContentTags());
		}
		if(content.getTxts()!=null){
			HibernateProxyUtil.loadHibernateProxy(content.getTxts());
		}
