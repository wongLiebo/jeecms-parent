...
public class QCoreUser extends EntityPathBase<CoreUser> {
    ...
    public final BooleanPath auditAdmin = createBoolean("auditAdmin");

    public final BooleanPath auditReinsuranceAdmin = createBoolean("auditReinsuranceAdmin");
    ...
    public final BooleanPath safetyAdmin = createBoolean("safetyAdmin");

    public final BooleanPath safetyReinsuranceAdmin = createBoolean("safetyReinsuranceAdmin");
